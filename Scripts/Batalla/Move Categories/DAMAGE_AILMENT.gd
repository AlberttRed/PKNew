...
func doEffect():
	...
	if moveCausesAilment()  and !target.fainted and !move.actualTarget.activePokemon.hasWorkingEffect(move.ailment.name) and !(move.actualTarget.activePokemon.hasStatusAilment() and move.ailment.isStatusAilment):
		print("Cause ailment!")
