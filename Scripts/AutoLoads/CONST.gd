...
class BATTLE:
	...
	#-244
	const SINGLE_PLAYERHPBAR_INITIALPOSITION = Vector2(770, -3)
	const SINGLE_PLAYERHPBAR_FINALPOSITION = Vector2(526, -3)
	const SINGLE_ENEMYHPBAR_INITIALPOSITION = Vector2(-386, -45)
	const SINGLE_ENEMYHPBAR_FINALPOSITION = Vector2(-144, -45)
