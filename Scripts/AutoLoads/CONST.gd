...
class BATTLE:
	...
	const FRONT_SINGLE_SPRITE_POS = Vector2(128, -16)#-32 per 190x190, -16 per 160x160     SI HA DE SUMAR EL DOBLE DEL VALOR BattlerEnemyY DE L ESSENTIALS
	...
	const SINGLE_PLAYERHPBAR_INITIALPOSITION = Vector2(526, -3)
	const SINGLE_ENEMYHPBAR_INITIALPOSITION = Vector2(-144, -45)
