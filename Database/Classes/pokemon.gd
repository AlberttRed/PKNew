...
@export var growth_rate_id = 1 #indica la velocitat en la que puja de nivell(quantitat d experiencia q guanya) aquest pokemon. Hi ha 5/6 nivells, de mes lent a mes rapid.

@export var egg_group_a_id:int #id del grupo huevo 1
@export var egg_group_b_id:int #id del grupo huevo 2
...
@onready var move_instance_script = load("res://Database/Instances/move_instance.gd")
