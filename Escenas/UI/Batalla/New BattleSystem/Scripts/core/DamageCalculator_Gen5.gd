...
static func calculate(move: BattleMove_Refactor, user: BattlePokemon_Refactor, target: BattlePokemon_Refactor) -> DamageResult:
	...
	return DamageResult.new(int(total), is_crit, effectiveness)
